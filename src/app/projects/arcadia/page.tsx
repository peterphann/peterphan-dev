...
import { arcadiaTeam } from "@/data/team-members";
        ...
        <div className="max-w-4xl mx-auto px-6 py-12">
          ...
          <div className="mb-16">
            ...
            <div className="text-center mb-8">
              ...
              >
                An online arcade that combines retro aesthetics with the
                technology of the future. Made for HackTX 2024.
              </motion.p>
            </div>
            ...
            >
              <div className="bg-neutral-800/50 backdrop-blur-sm rounded-xl p-6 border border-neutral-700/50 hover:border-blue-500/30 transition-all duration-300">
                ...
                <p className="text-white font-semibold">Nov. 2024</p>
              </div>
            ...
            >
              ...
              <div className="flex flex-col md:flex-row gap-4">
                <a
                  href="https://devpost.com/software/arcadia-xgwt0s"
                  target="_blank"
                  rel="noopener noreferrer"
          ...
          <motion.section
            ...
            animate={
              isTechStackInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 50 }
            }
            transition={{ duration: 0.8, ease: "easeOut" }}
          >
